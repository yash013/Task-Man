        ...
        <Tabs.TabPane tab="Task Details" key="1">
          ...
          >
            <Form.Item label="Task Name" name="name">
              <Input className= "text-gray-400" placeholder="Task Name"/>
            </Form.Item>

            <Form.Item className="text-gray-700" label="Task Description" name="description">
              <TextArea className= "text-gray-400" placeholder="Task Description"/>
            </Form.Item>
